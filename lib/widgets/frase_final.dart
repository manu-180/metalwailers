...
class _FraseFinalState extends State<FraseFinal> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric( horizontal: isWide ? size.width * 0.15 :  size.width * 0.10 ),
        child: Column(
